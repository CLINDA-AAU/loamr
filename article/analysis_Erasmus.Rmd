...
# Data
Here we consider measurements on lung tumours from a study described in Erasmus et al (2003). The data is in wide format, but is transformed into long format before it is fed to the 'LOAM' function.
